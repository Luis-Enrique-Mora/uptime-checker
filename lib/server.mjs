...
/*
handlers.sendTwilioSms( '87355909', 'Hello from node app', function( error ) {
    console.log(error);
} );
*/
...
const server = http.createServer( function( req, res ){
    ...
    var choosenHandler = typeof(server.router[trimmedPath]) !== 'undefine' ? server.router[trimmedPath] : handlers.notFound;
